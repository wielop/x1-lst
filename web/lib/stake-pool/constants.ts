...
// Public key that identifies our fork of the SPL Stake Pool program on X1 testnet.
// NOTE: this is a DIFFERENT address than mainnet — update via poolConfig.ts network switch
// before going live on X1 mainnet (see ../poolConfig.ts).
export const STAKE_POOL_PROGRAM_ID = new PublicKey('HjJ81j6LvguqZP17WwPrWihqpCqWYMqPdVCEDtDXDd23');
